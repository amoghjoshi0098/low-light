...
train_files = glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/20220114*.dng')
train_files +=glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/20220115*.dng')
train_files +=glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/20220116*.dng')
...
for x in train_files:
    gt_files = glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/GT/20220114*.dng')
    gt_files += glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/GT/20220115*.dng')
    gt_files += glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/GT/20220116*.dng')
...
test_files = glob.glob('/content/drive/MyDrive/new_dataset/new_dataset/train_img_outdoor/RAW/20220116*.dng') 
if dry_run:
